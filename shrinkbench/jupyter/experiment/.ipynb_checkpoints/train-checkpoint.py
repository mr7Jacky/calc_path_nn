...
from .. import models
from ..metrics import correct, class_accuracy
    ...
    def run_epoch(self, train, epoch=0):
        ...
        with torch.set_grad_enabled(train):
            for i, (x, y) in enumerate(epoch_iter, start=1):
                ...
                ###  ADDED BY THOMAS TO LOOK AT CLASS ACCURACY ###
                # if not train:
                #     class_accuracy_results = class_accuracy(yhat, y)
                #     print(class_accuracy_results)
