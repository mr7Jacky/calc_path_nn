...
__all__ = ['ResNet', 'resnet20', 'resnet32', 'resnet44', 'resnet56', 'resnet110', 'resnet1202', 'resnet56_C']
...
def resnet_factory(filters, num_classes, name):
    ...
    def _resnet(pretrained=False):
        ...
        if name == 'resnet56_C' or name == 'resnet20':
            pretrained = False
        if pretrained:
...
resnet20 = resnet_factory([3, 3, 3], 2, 'resnet20')
...
resnet56_C = resnet_factory([9, 9, 9], 100, 'resnet56_C')
